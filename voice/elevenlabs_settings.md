...
- "Awnt" is the tested phonetic spelling that makes ElevenLabs pronounce
  "Aunt" as "ahnt". Use it in narration text whenever her name is spoken;
  never let it appear in captions or on-screen text (use "Aunt/Auntie" there).
